      ...
      <div className="flex-grow flex flex-col p-4 md:p-8">
        ...
        <div className="flex flex-col items-center justify-center flex-grow text-center mb-8 md:mb-16">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4">
            ...
            <button className="bg-black group gap-3 md:text-2xl text-white hover:bg-zinc-900 px-4 py-2 sm:px-8 sm:py-4 md:px-24 md:py-8 rounded-full text-base sm:text-lg font-medium flex items-center justify-center transition-colors duration-200">
  What We Do?
          ...
          {serviceData.map((service, index) => (
            ...
            >
              <div className="bg-card text-card-foreground border border-border h-full flex flex-col p-6 group rounded-lg">
                ...
                <p className="text-sm mb-4 text-muted-foreground flex-grow">{service.description}</p>
                <a
                  href={service.link}
