...
// const serviceData = [
//   {
//     icon: <RxCrop className="text-4xl sm:text-5xl" />,
...
//   },
//   {
//     icon: <RxPencil2 className="text-4xl sm:text-5xl" />,
...
//   },
//   {
//     icon: <RxDesktop className="text-4xl sm:text-5xl" />,
...
//   },
//   {
//     icon: <RxReader className="text-4xl sm:text-5xl" />,
...
//   },
//   {
//     icon: <RxRocket className="text-4xl sm:text-5xl" />,
...
//           className="mb-4 sm:mb-6 text-white bg-white bg-opacity-20 p-3 sm:p-4 rounded-full inline-block"
//         >
//           {service.icon}
//         </motion.div>
...
//           <motion.span
//             className="text-white font-semibold py-2 px-3 sm:px-4 rounded-full bg-purple-600 hover:bg-purple-500 transition-colors duration-300 shadow-md"
...
//   return (
//     <section className="bg-gradient-to-b from-gray-900 to-black py-16 sm:py-20 relative overflow-hidden">
...
//           transition={{ duration: 0.5 }}
//           className="text-4xl sm:text-5xl font-extrabold text-center text-white mb-12 sm:mb-16 leading-tight"
//         >
